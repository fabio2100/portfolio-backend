...
public class ExperienciaLaboralController {
    ...
    ExperienciaLaboralController(ExperienciaLaboralRepository experienciaLaboralRepository){
        this.experienciaLaboralRepository = experienciaLaboralRepository; 
    }
    
    @GetMapping("/experiencialaboral")
    public List<ExperienciaLaboralModel> index(){
        System.out.println("domiciilios controller");
        System.out.println(experienciaLaboralRepository.findAll());
